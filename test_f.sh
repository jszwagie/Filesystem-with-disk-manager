...
# Kompilacja programu
cc -std=c89 -o disk_manager disk_manager.c
...
LONG_NAME_FILE="Długa nazwa.txt"
...
echo "mv ala_ma_kota.txt ala_ma_kotac.txt" >> $OUTPUT_FILE_COMMANDS 2>&1
mv ala_ma_kota.txt ala_ma_kotac.txt
...
echo "---------------------------------------------------" >> $OUTPUT_FILE_COMMANDS 2>&1
echo "diff ala_ma_kota.txt ala_ma_kotac.txt" >> $OUTPUT_FILE_COMMANDS 2>&1
diff ala_ma_kota.txt ala_ma_kotac.txt >> $OUTPUT_FILE 2>&1
echo "cat ala_ma_kota.txt" >> $OUTPUT_FILE_COMMANDS 2>&1
cat ala_ma_kota.txt >> $OUTPUT_FILE 2>&1
echo "cat ala_ma_kotac.txt" >> $OUTPUT_FILE_COMMANDS 2>&1
cat ala_ma_kotac.txt >> $OUTPUT_FILE 2>&1
echo "--------------------------------------------------" >> $OUTPUT_FILE_COMMANDS 2>&1
...
rm ala_ma_kotac.txt lorem_ipsumc.txt
